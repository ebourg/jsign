...
[![Build Status](https://api.travis-ci.com/ebourg/jsign.svg)](https://travis-ci.com/ebourg/jsign)
...
* Keystores supported: PKCS#12, JKS and PKCS#11 hardware tokens (YubiKey, Nitrokey, etc)
