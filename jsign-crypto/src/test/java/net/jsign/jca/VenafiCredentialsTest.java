...
public class VenafiCredentialsTest {
    ...
    public void testGetSessionToken() throws Exception {
        ...
        VenafiCredentials credentials = new VenafiCredentials("ebourg", "123456", null, null);
    ...
    public void testGetSessionTokenFailed() {
        ...
        assertEquals("message", "Failed to authenticate with Venafi: Error authenticating user", e.getMessage());
    }
}
