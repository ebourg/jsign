...
public class CodeSignSecureCredentialsTest {
    ...
    public void testGetSSLContext() throws Exception {
        CodeSignSecureCredentials credentials = new CodeSignSecureCredentials(null, null, "target/test-classes/keystores/keystore.p12", "password");
        SSLContext ctx = credentials.getSSLContext();
        assertNotNull("null context", ctx);
    }
}
