...
public class AzureTrustedSigningService implements SigningService {
    ...
    private SignStatus sign(String account, String profile, String algorithm, byte[] data) throws IOException {
        ...
        Map<String, ?> response = client.post("/codesigningaccounts/" + account + "/certificateprofiles/" + profile + "/sign?api-version=2023-06-15-preview", JsonWriter.format(request));
        ...
        while (System.currentTimeMillis() - startTime < timeout * 1000) {
            ...
            response = client.get("/codesigningaccounts/" + account + "/certificateprofiles/" + profile + "/sign/" + operationId + "?api-version=2023-06-15-preview");
