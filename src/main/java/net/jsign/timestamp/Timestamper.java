...
public abstract class Timestamper {
    ...
    public CMSSignedData timestamp(PESigner.HashAlgo algo, CMSSignedData sigData) throws IOException, CMSException {
    ...
    protected abstract CMSSignedData timestamp(PESigner.HashAlgo algo, byte[] encryptedDigest) throws IOException, CMSException;
}
