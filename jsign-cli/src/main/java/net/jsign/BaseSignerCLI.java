...
import static net.jsign.PESignerHelper.PARAM_ALG;
import static net.jsign.PESignerHelper.PARAM_ALIAS;
import static net.jsign.PESignerHelper.PARAM_CERTFILE;
import static net.jsign.PESignerHelper.PARAM_KEYFILE;
import static net.jsign.PESignerHelper.PARAM_KEYPASS;
import static net.jsign.PESignerHelper.PARAM_KEYSTORE;
import static net.jsign.PESignerHelper.PARAM_NAME;
import static net.jsign.PESignerHelper.PARAM_PROXY_PASS;
import static net.jsign.PESignerHelper.PARAM_PROXY_URL;
import static net.jsign.PESignerHelper.PARAM_PROXY_USER;
import static net.jsign.PESignerHelper.PARAM_STOREPASS;
import static net.jsign.PESignerHelper.PARAM_STORETYPE;
import static net.jsign.PESignerHelper.PARAM_TSAURL;
import static net.jsign.PESignerHelper.PARAM_TSMODE;
import static net.jsign.PESignerHelper.PARAM_TSRETRIES;
import static net.jsign.PESignerHelper.PARAM_TSRETRY_WAIT;
import static net.jsign.PESignerHelper.PARAM_URL;
 ...
 * @since 1.1
 */
abstract class BaseSignerCLI<T extends BaseSignerHelper> {
    ...
    void execute(String... args) throws SignerException, ParseException {
        ...
        T helper = createSignerHelper(new StdOutConsole(), "option");
        ...
        doExecute(helper, cmd, file);
    }

    abstract T createSignerHelper(Console console, String parameterName);

    abstract void doExecute(T signerHelper, CommandLine cmd, File file) throws SignerException;

    protected void setOption(String key, T helper, CommandLine cmd) {
