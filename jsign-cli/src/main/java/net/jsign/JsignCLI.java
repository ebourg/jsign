...
public class JsignCLI {
    ...
    JsignCLI() {
        ...
        options.addOption(OptionBuilder.withLongOpt(PARAM_SCRIPT_ENCODING).withDescription("The encoding of the PowerShell script to be signed (UTF-8 by default).").create());
