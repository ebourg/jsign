...
/**
 * Base Ant task for signing executable files.
 */
abstract class BaseSignerTask<T extends BaseSignerHelper> extends Task {
    ...
    public void execute() throws BuildException {
        try {
            T helper = createSignerHelper(new AntConsole(this), "attribute");
