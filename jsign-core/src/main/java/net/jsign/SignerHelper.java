...
class SignerHelper {
    ...
    private AuthenticodeSigner build() throws SignerException {
        ...
        if ("PKCS11".equals(storetype)) {
            ...
            provider = new SigningServiceJcaProvider(new GoogleCloudSigningService(keystore.getPath(), storepass, new Function<String, Certificate[]>() {
    ...
    private void attach(File file) throws IOException, CMSException {
        ...
        Signable signable = Signable.Builder.of(file, encoding);
