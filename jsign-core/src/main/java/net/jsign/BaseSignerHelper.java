...
/**
 * Helper class to create signer instances with untyped parameters.
 * This is used internally to share the parameter validation logic
 * between the Ant task and the CLI tool.
 *
 * @since 2.0
 */
abstract class BaseSignerHelper<T extends BaseSignerHelper, S extends BaseSigner> {
    ...
    public BaseSignerHelper(String parameterName) {
    ...
    public T keystore(File keystore) {
        this.keystore = keystore;
        return (T) this;
    }

    public T storepass(String storepass) {
        this.storepass = storepass;
        return (T) this;
    }

    public T storetype(String storetype) {
    ...
    public T keypass(String keypass) {
    ...
    public T certfile(String certfile) {
    ...
    protected S build() throws SignerException {
        ...
        return (S) createSigner(chain, privateKey)
    ...
    abstract S createSigner(Certificate[] chain, PrivateKey privateKey);
